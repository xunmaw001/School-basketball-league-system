    ...
    <view class="content">
        <form class="app-update-pv">
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="qiuyuanCollectionTypesChange" :value="qiuyuanCollectionTypesIndex" :range="qiuyuanCollectionTypesOptions" range-key="indexName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.qiuyuanCollectionTypes?ruleForm.qiuyuanCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let qiuyuanCollectionTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'qiuyuan_collection_types',
            }
			let qiuyuanCollectionTypes = await this.$api.page(`dictionary`, qiuyuanCollectionTypesParams);
			this.qiuyuanCollectionTypesOptions = qiuyuanCollectionTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`qiuyuanCollection`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.qiuyuanCollectionId){
                this.ruleForm.qiuyuanCollectionId = options.qiuyuanCollectionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            // 下拉变化
            qiuyuanCollectionTypesChange(e) {
            ...
            async onSubmitTap() {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`qiuyuanCollection`, this.ruleForm);
                } else {
                    await this.$api.save(`qiuyuanCollection`, this.ruleForm);
                }
