...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('qiuyuan')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
      :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
        <view @tap="onDetailTap('qiuyuan',product.id)"
          :style='{"borderRadius":"12rpx","backgroundColor":"#fff"}' class="uni-product"
          v-for="(product,index) in qiuyuanList" :key="index">
        ...
        <view class="image-view" :style='{"borderRadius":"20rpx","height":"320rpx"}'>
            <image mode="aspectFill" :style='{"borderRadius":"20rpx","height":"320rpx"}'
                   class="uni-product-image" :src="baseUrl+product.qiuyuanPhoto"></image>
        </view>
        <view class="uni-product-price"
              :style='{"fontSize":"24rpx","lineHeight":"48rpx","color":"var(--publicMainColor)","textAlign":"center"}'>
            <text v-if="product.qiuyuanNewMoney">￥{{product.qiuyuanNewMoney}}</text>
        </view>
    </view>
</view>
        </view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('qiudui')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
      :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
        <view @tap="onDetailTap('qiudui',product.id)"
          :style='{"borderRadius":"12rpx","backgroundColor":"#fff"}' class="uni-product"
          v-for="(product,index) in qiuduiList" :key="index">
        <view class="uni-product-title"
              :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}'>
            {{product.qiuduiName}}
        </view>
        <view class="image-view" :style='{"borderRadius":"20rpx","height":"320rpx"}'>
            <image mode="aspectFill" :style='{"borderRadius":"20rpx","height":"320rpx"}'
                   class="uni-product-image" :src="baseUrl+product.qiuduiPhoto"></image>
        </view>
        <view class="uni-product-price"
              :style='{"fontSize":"24rpx","lineHeight":"48rpx","color":"var(--publicMainColor)","textAlign":"center"}'>
            <text v-if="product.qiuduiNewMoney">￥{{product.qiuduiNewMoney}}</text>
        </view>
    </view>
</view>
        </view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('saishixinxi')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
      :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
        <view @tap="onDetailTap('saishixinxi',product.id)"
          :style='{"borderRadius":"12rpx","backgroundColor":"#fff"}' class="uni-product"
          v-for="(product,index) in saishixinxiList" :key="index">
        <view class="uni-product-title"
              :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}'>
            {{product.saishixinxiZhudui}}VS{{product.saishixinxiKedui}}
        </view>
        <view class="image-view" :style='{"borderRadius":"20rpx","height":"320rpx"}'>
            <image mode="aspectFill" :style='{"borderRadius":"20rpx","height":"320rpx"}'
                   class="uni-product-image" :src="baseUrl+product.saishixinxiPhoto"></image>
        </view>
        <view class="uni-product-price"
              :style='{"fontSize":"24rpx","lineHeight":"48rpx","color":"var(--publicMainColor)","textAlign":"center"}'>
            <text v-if="product.saishixinxiNewMoney">￥{{product.saishixinxiNewMoney}}</text>
        </view>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let qiuyuan = await this.$api.requestCondition('qiuyuan','gexingtuijian',qiuyuanVal);

            this.qiuyuanList = qiuyuan.data.list
            this.qiuyuanList.forEach(function(item, index) {
            ...
            let qiudui = await this.$api.requestCondition('qiudui','gexingtuijian',qiuduiVal);

            this.qiuduiList = qiudui.data.list
            this.qiuduiList.forEach(function(item, index) {
            ...
            let saishixinxi = await this.$api.requestCondition('saishixinxi','gexingtuijian',saishixinxiVal);

            this.saishixinxiList = saishixinxi.data.list
            this.saishixinxiList.forEach(function(item, index) {
