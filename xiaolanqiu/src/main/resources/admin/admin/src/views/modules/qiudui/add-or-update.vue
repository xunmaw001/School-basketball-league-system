               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="球队位置" prop="qiuduiAddress">
                       <el-input v-model="ruleForm.qiuduiAddress"
                                 placeholder="球队位置" clearable  :readonly="ro.qiuduiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="胜率" prop="qiuduiShenglv">
                       <el-input v-model="ruleForm.qiuduiShenglv"
                                 placeholder="胜率" clearable  :readonly="ro.qiuduiShenglv"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   qiuduiAddress: [
                              { required: true, message: '球队位置不能为空', trigger: 'blur' },
                          ],
                   zanNumber: [
